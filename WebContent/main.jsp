...
<script language="javascript"
	src="../js/elbeanio-jquery.tagsphere-c62e76bdd7be/ext/jquery.mousewheel.min.js"></script>
<script language="javascript"
	src="../js/elbeanio-jquery.tagsphere-c62e76bdd7be/jquery.tagsphere.js"></script>
<script language="javascript"
	src="../js/elbeanio-jquery.tagsphere-c62e76bdd7be/jquery.tagsphere.min.js"></script>
<script type="text/javascript"
...
<link rel="stylesheet" type="text/css"
	...
	media="screen" />
<link rel="stylesheet" type="text/css"
	href="../js/jquery.fancybox-1.3.4/style.css" type="text/css"
	media="screen" />

<script type="text/javascript"
	src="../js/jquery.mb.maskedGallery.1.9.2/inc/mbMaskedGallery.js"></script>
<script type="text/javascript"
	src="../js/jquery.mb.maskedGallery.1.9.2/inc/jquery.metadata.js"></script>
...
<body>
	<form>
		<div id="tags" style="width: 500px; height: 500px;">
			<ul>
				<s:iterator value="tags">
					<li><s:url var="fancyUrl" action="fancy" namespace="/struts">
							<s:param name="clusterLoc">
								<s:property value="clusterLoc" />
							</s:param>
						</s:url> <a href="javascript:displayFancyBoxJS('${fancyUrl}')" rel="10"><s:property
								value="info" />
					</a>
					</li>
				</s:iterator>
		...
		<a title="HERE IS THE TITLE ^o^v" id="example5"
			href="http://www.youtube.com/watch?v=071KqJu7WVo&feature=player_embedded#at=41">
			<img
			src="http://farm3.static.flickr.com/2502/5767667841_d23dc43103_t.jpg"
			alt="example5" id="5767667841"> </a> <img
			src="http://iantearle.com/expanse/uploads/1309279305_iskip_iskip.png"
			title="iSkip" alt="iSkip" id="mousemove" />


		<s:iterator value="clusters">
